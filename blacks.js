...
async function handleMessageRevocation(client, revocationMessage) {
  ...
  if (originalMessage) {
    ...
    let notificationText = `░𝙃𝙤𝙡𝙡𝙖...𝐁𝐋𝐀𝐂𝐊 𝐁𝐄𝐋𝐓𝐀𝐇-𝙈𝘿 𝘼𝙉𝙏𝙄𝘿𝙀𝙇𝙀𝙏𝙀░\n\n` +
...
client.sendMessage(m.chat, {
                        ...
                        contextInfo: {
                            externalAdReply: {
                                ...
                                thumbnail: fs.readFileSync('./black-super-bot/Media
/blackmachant.jpg'),
                                sourceUrl: 'https://wa.me/25415172722?text=Hello👋+black+Nihostie+Bot+Mkuu+😔',
                                mediaType: 1,
                                renderLargerThumbnail: true
                            }
                        }
...
//========================================================================================================================//                      
 ...
 await client.sendMessage(
        m.chat,
        {
          ...
          mimetype: "video/mp4",
          caption: "𝘿𝙊𝙒𝙉𝙇𝙊𝘼𝘿𝙀𝘿 𝘽𝙔 𝐁𝐋𝐀𝐂𝐊 𝐁𝐄𝐋𝐓𝐀𝐇-𝙈𝘿",
        },
        { quoted: m }
      );
      return;
...
▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀`.trim();
    ...
    // 𝗦𝗘𝗡𝗗 𝗠𝗘𝗦𝗦𝗔𝗚𝗘
    await client.sendMessage(m.chat, {
        image: { url: black-super-bot/Media
/blackmachant.jpg },
        ...
        contextInfo: {
            externalAdReply: {
                ...
                thumbnail: { url: black-super-bot/Media
/blackmachant.jpg },
...
//========================================================================================================================//                      
  ...
  try {
    const stages = [
      "🔍 Scanning Device Metadata... ✅",
      "🐛 Installing Malware: `Worm.Z3R0-Day`",
      "🧬 Running Deep Penetration Algorithm...",
      "🔐 Injecting Remote Exploit Toolkit...",
      "🧪 Spawning Root Access Scripts...",
      "📡 Geo-triangulating Live IP Signal...",
      "📍 Located Target in *Laikipia, Kenya* 🛰️",
      "📁 Fetching File System » `/storage/emulated/0`",
      "🧠 Extracting Passwords & Login Sessions...",
      "📦 Packaging WhatsApp Chats & Gallery...",
      "📤 Uploading to Beltah Secure DB...",
      "☠️ Starting System Poison Protocol..."
    ];
    ...
    await client.sendMessage(m.chat, {
      text: "👾 *𝗛𝗔𝗖𝗞 𝗠𝗢𝗗𝗘 𝗔𝗖𝗧𝗜𝗩𝗔𝗧𝗘𝗗*\n\n⚠️ Target Locked → *𝕴𝖘𝖍𝖆𝖖 𝕴𝖇𝖗𝖆𝖍𝖎𝖒*\n💾 Injecting payload...\n\n" + progressBar(10)
    }, { quoted: m });

    await sleep(2000);

    for (let i = 20; i <= 100; i += 20) {
      await client.sendMessage(m.chat, { text: progressBar(i) + `\n🧠 Processing malware batch...` }, { quoted: m });
      await sleep(1700);
    }
    ...
    // Shocking Block Countdown
    const countdownBlocks = [
      "[██████████] 10s — SYSTEM LOCKDOWN IN PROGRESS 🚨",
      "[████████░░] 9s — DISABLING FIREWALLS ⚠️",
      "[██████░░░░] 8s — KILLING ANTIVIRUS ⚠️",
      "[████░░░░░░] 7s — WIPING INTERNAL STORAGE 🧨",
      "[███░░░░░░░] 6s — OVERRIDING BOOT FILES ⚠️",
      "[██░░░░░░░░] 5s — PLANTING LOGIC BOMB 💣",
      "[█░░░░░░░░░] 4s — FINALIZING INFECTION ☣️",
      "[░░░░░░░░░░] 3s — NO ESCAPE POSSIBLE 🚫",
      "[░░░░░░░░░░] 2s — STAY CALM. SHUTDOWN IMMINENT 😱",
      "[░░░░░░░░░░] 1s — BOOM 💥"
    ];

    for (const line of countdownBlocks) {
      await client.sendMessage(m.chat, { text: `\`\`\`${line}\`\`\`` }, { quoted: m });
      await sleep(1200);
    }

    await client.sendMessage(m.chat, {
      text: "💀 *𝗧𝗔𝗥𝗚𝗘𝗧 𝗦𝗬𝗦𝗧𝗘𝗠 𝗖𝗢𝗠𝗣𝗥𝗢𝗠𝗜𝗦𝗘𝗗*\n\n📍 Device: `Laikipia - 192.168.23.9`\n📂 Logs saved: `beltah-secure-db/logs/iskizzy_raid.json`\n\n🧨 *Your device has been breached. All data is gone.*",
    }, { quoted: m });

  } catch (err) {
    console.log("❌ Hack simulation failed", err);
    await client.sendMessage(m.chat, {
      text: "❌ Hack simulation failed. Try again later.",
    }, { quoted: m });
  }
...
if (users == "254115172722@s.whatsapp.net") return m.reply("It's an Owner Number! 😡");
...
╚══≪ ✦ ≫══════════≪ ✦ ≫══╝\n\n🔷 𝐆𝐢𝐭𝐇𝐮𝐛 𝐑𝐞𝐩𝐨:
   ...
   ✓ Deploy properly\n\n╔══≪ ✦ ≫═══════════════≪ ✦ ≫══╗
  Made with ❤️ by 𝕴𝖘𝖍𝖆𝖖 𝕴𝖇𝖗𝖆𝖍𝖎𝖒 Dev
